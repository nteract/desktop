...
export const encode_cursor_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const encode_selection_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
export const encode_focus_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
