...
export const notebookhandle_get_cell_output_mime_types: (a: number, b: number, c: number) => number;
...
export const notebookhandle_get_cell_required_plugins: (a: number, b: number, c: number) => number;
