...
export const notebookhandle_get_cell_outputs_json: (a: number, b: number, c: number, d: number) => void;
export const notebookhandle_get_cell_execution_count: (a: number, b: number, c: number, d: number) => void;
export const notebookhandle_get_cell_metadata_json: (a: number, b: number, c: number, d: number) => void;
