...
export interface InitOutput {
    ...
    readonly encode_clear_channel_presence: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_cursor_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number, number];
    readonly encode_focus_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    readonly encode_selection_presence: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number, number, number];
    readonly jscell_cell_type: (a: number) => [number, number];
    readonly jscell_execution_count: (a: number) => [number, number];
    readonly jscell_id: (a: number) => [number, number];
    readonly jscell_metadata_json: (a: number) => [number, number];
    readonly jscell_outputs_json: (a: number) => [number, number];
    readonly jscell_position: (a: number) => [number, number];
    readonly jscell_resolved_assets_json: (a: number) => [number, number];
    readonly jscell_source: (a: number) => [number, number];
    readonly notebookhandle_add_cell: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly notebookhandle_add_cell_after: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
    readonly notebookhandle_add_conda_dependency: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_add_pixi_dependency: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_add_uv_dependency: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_append_source: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    ...
    readonly notebookhandle_clear_conda_section: (a: number) => [number, number];
    readonly notebookhandle_clear_pixi_section: (a: number) => [number, number];
    readonly notebookhandle_clear_uv_section: (a: number) => [number, number];
    readonly notebookhandle_contributing_actors: (a: number) => [number, number];
    readonly notebookhandle_create_bootstrap: (a: number, b: number) => number;
    readonly notebookhandle_create_empty: () => number;
    readonly notebookhandle_delete_cell: (a: number, b: number, c: number) => [number, number, number];
    readonly notebookhandle_detect_runtime: (a: number) => [number, number];
    readonly notebookhandle_flush_local_changes: (a: number) => [number, number];
    readonly notebookhandle_flush_pool_state_sync: (a: number) => [number, number];
    readonly notebookhandle_flush_runtime_state_sync: (a: number) => [number, number];
    readonly notebookhandle_get_actor_id: (a: number) => [number, number];
    readonly notebookhandle_get_cell: (a: number, b: number, c: number) => number;
    readonly notebookhandle_get_cell_execution_count: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_get_cell_execution_id: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_get_cell_ids: (a: number) => [number, number];
    readonly notebookhandle_get_cell_metadata: (a: number, b: number, c: number) => any;
    readonly notebookhandle_get_cell_outputs: (a: number, b: number, c: number) => any;
    readonly notebookhandle_get_cell_position: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_get_cell_source: (a: number, b: number, c: number) => [number, number];
    ...
    readonly notebookhandle_get_metadata_snapshot_json: (a: number) => [number, number];
    readonly notebookhandle_get_metadata_value: (a: number, b: number, c: number) => any;
    readonly notebookhandle_get_output_by_id: (a: number, b: number, c: number) => any;
    readonly notebookhandle_get_output_ids_for_execution: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_get_pool_state: (a: number) => any;
    readonly notebookhandle_get_runtime_state: (a: number) => any;
    readonly notebookhandle_load: (a: number, b: number) => [number, number, number];
    readonly notebookhandle_load_state_doc: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_move_cell: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly notebookhandle_new: (a: number, b: number) => number;
    readonly notebookhandle_receive_frame: (a: number, b: number, c: number) => any;
    readonly notebookhandle_receive_sync_message: (a: number, b: number, c: number) => [number, number, number];
    readonly notebookhandle_remove_conda_dependency: (a: number, b: number, c: number) => [number, number, number];
    readonly notebookhandle_remove_pixi_dependency: (a: number, b: number, c: number) => [number, number, number];
    readonly notebookhandle_remove_uv_dependency: (a: number, b: number, c: number) => [number, number, number];
    readonly notebookhandle_reset_sync_state: (a: number) => void;
    readonly notebookhandle_resolve_comm_state: (a: number, b: number, c: number) => any;
    readonly notebookhandle_save: (a: number) => [number, number];
    ...
    readonly notebookhandle_set_cell_metadata: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly notebookhandle_set_cell_metadata_value: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly notebookhandle_set_cell_outputs_hidden: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly notebookhandle_set_cell_source_hidden: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly notebookhandle_set_cell_tags: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly notebookhandle_set_cell_tags_value: (a: number, b: number, c: number, d: any) => [number, number, number];
    ...
    readonly notebookhandle_set_conda_channels: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_set_conda_python: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_set_metadata: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly notebookhandle_set_metadata_snapshot_value: (a: number, b: any) => [number, number];
    readonly notebookhandle_set_metadata_value: (a: number, b: number, c: number, d: any) => [number, number];
    readonly notebookhandle_set_mime_priority: (a: number, b: any) => void;
    readonly notebookhandle_set_pixi_channels: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_set_pixi_python: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_set_uv_prerelease: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_set_uv_requires_python: (a: number, b: number, c: number) => [number, number];
    readonly notebookhandle_splice_source: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly notebookhandle_update_cell_metadata_at: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly notebookhandle_update_cell_metadata_at_value: (a: number, b: number, c: number, d: any, e: any) => [number, number, number];
    readonly notebookhandle_update_source: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly notebookhandle_generate_pool_state_sync_reply: (a: number) => [number, number];
    readonly notebookhandle_generate_runtime_state_sync_reply: (a: number) => [number, number];
