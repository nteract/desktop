...
export interface InitOutput {
    ...
    readonly cast_column: (a: number, b: number, c: number, d: number) => [number, number];
    readonly col_names: (a: number) => [number, number, number];
    readonly col_timezone: (a: number, b: number) => [number, number, number, number];
    readonly col_type: (a: number, b: number) => [number, number, number, number];
    readonly filter_rows: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly free: (a: number) => void;
    readonly get_cell_f64: (a: number, b: number, c: number) => [number, number, number];
    readonly get_cell_string: (a: number, b: number, c: number) => [number, number, number, number];
    readonly get_viewport: (a: number, b: number, c: number) => [number, number, number, number];
    readonly get_viewport_by_indices: (a: number, b: number, c: number) => [number, number, number, number];
    readonly has_original_column: (a: number, b: number) => [number, number, number];
    readonly histogram: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly init: () => void;
    readonly is_null: (a: number, b: number, c: number) => [number, number, number];
    readonly load_ipc: (a: number, b: number) => [number, number, number];
    readonly load_parquet: (a: number, b: number) => [number, number, number];
    readonly load_parquet_row_group: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly num_cols: (a: number) => [number, number, number];
    readonly num_rows: (a: number) => [number, number, number];
    readonly parquet_metadata: (a: number, b: number) => [number, number, number, number];
    readonly parquet_schema_metadata: (a: number, b: number) => [number, number, number];
    readonly store_bool_counts: (a: number, b: number) => [number, number, number, number];
    readonly store_filter_rows: (a: number, b: any) => [number, number, number, number];
    readonly store_filtered_bool_counts: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly store_filtered_histogram: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly store_filtered_value_counts: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly store_histogram: (a: number, b: number, c: number) => [number, number, number];
    ...
    readonly write_parquet_from_sqlite: (a: any, b: any) => [number, number, number, number];
    readonly write_parquet_ipc: (a: number, b: number) => [number, number, number, number];
