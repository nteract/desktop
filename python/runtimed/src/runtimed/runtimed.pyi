...
class Session:
    ...
    def restart_kernel(self, wait_for_ready: bool = True) -> None: ...
    ...
    def set_cell_source_hidden(self, cell_id: str, hidden: bool) -> None: ...
    def set_cell_outputs_hidden(self, cell_id: str, hidden: bool) -> None: ...
    def set_cell_tags(self, cell_id: str, tags: list[str]) -> None: ...
...
class AsyncSession:
    ...
    def restart_kernel(self, wait_for_ready: bool = True) -> Coroutine[Any, Any, None]: ...
    ...
    def get_cell(self, cell_id: str) -> Coroutine[Any, Any, Cell | None]: ...
    ...
    def set_cell_source_hidden(self, cell_id: str, hidden: bool) -> Coroutine[Any, Any, None]: ...
    def set_cell_outputs_hidden(self, cell_id: str, hidden: bool) -> Coroutine[Any, Any, None]: ...
    def set_cell_tags(self, cell_id: str, tags: list[str]) -> Coroutine[Any, Any, None]: ...
