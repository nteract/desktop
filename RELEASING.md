...
|--------|-----|---------|-------------|
| **Stable** | `v{version}-stable.{sha}` | Push to `main` or manual | GitHub Releases |
...
Stable releases run on each push to `main`, and nightly pre-releases run every 24 hours. Both can also be triggered manually.
